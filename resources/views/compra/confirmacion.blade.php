        ...
        <ul>
            @foreach($productosEnCarrito as $producto)
                <li style="border-bottom: 1px solid #eee; padding: 10px 0; position: relative;">
                    ...
                    <p><strong>Nombre del Producto:</strong> {{ $producto['nombre'] }} - <strong>Cantidad:</strong> {{ $producto['cantidad'] }} - <strong>Precio Total:</strong> {{ number_format($producto['precio'] * $producto['cantidad'], 2) }} €</p>
                </li>
            @endforeach
        </ul>
        <h3 style="margin-bottom: 5%;">Total a Pagar: {{ number_format($totalAPagar, 2) }} €</h3>
...
@if(session('success'))
    ...
    <script>
        // Redirigir a la tienda instantáneamente
...
@endif
 ...
 <footer class="footercar" style="position: fixed; bottom: 0; width: 100%;">
        <div>
